              ...
              {isSubmitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea id="message" required placeholder="Détaillez votre demande..." className="min-h-[150px] rounded-none bg-secondary/10" />
                  </div>
